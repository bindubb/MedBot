...
from app_test import css, bot_template, user_template
...
def main():
    ...
    with st.sidebar:
        st.image("/workspaces/llm-examples/bot.png")
        st.subheader("Your documents")
        pdf_docs = st.file_uploader("Upload your 🩺 MED PDFs here and click on 'Process",
